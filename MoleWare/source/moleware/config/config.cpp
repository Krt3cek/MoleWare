...
namespace Config {
	...
	bool showDead = false;
	bool showHead = false;
	ImVec4 headDotColor = ImVec4(1, 1, 1, 1);
	float headDotRadius = 1.0f;
	bool distance = false;
	bool teamCheck = true;
	bool espFill = false;
	...
	ImVec4 colViewmodelChams = ImVec4(1, 1, 1, 1);
	ImVec4 colArmChams = ImVec4(1, 1, 1, 1);

	ImVec4 colVisualChams = ImVec4(1, 1, 1, 1);
	ImVec4 colVisualChamsIgnoreZ = ImVec4(1, 1, 1, 1);
	ImVec4 teamcolVisualChamsIgnoreZ = ImVec4(1, 1, 1, 1);
	ImVec4 teamcolVisualChams = ImVec4(1, 1, 1, 1);

	float espThickness = 1.0f;
	float espFillOpacity = 0.5f;
	ImVec4 espColor = ImVec4(1, 1, 1, 1);
